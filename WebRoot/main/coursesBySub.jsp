...
<link rel="stylesheet"
	...
	type="text/css" />
	<link rel="stylesheet" href="/static/moco/v1.0/dist/css/moco.min.css?t=201703281204" type="text/css" />
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
		...
		<%
			...
			Subject subject=sdao.getSubjectById(sid);
		%>
		<!-- 这是主要main内容 -->
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					<%
						if(subject!=null)
							out.print("<<"+subject.getSubname()+">>"+"所有courses");
					%>
				</h1>
				<ol class="breadcrumb">
			...
			%>
					...
					<div class='index-card-container course-card-container container '>
							...
							<a target="_blank" class='course-card' href="../servlet/VideoServlet?courseid=<%=courses.get(i).getCid() %>">
							<div class='course-card-top cart-color cyan'>
									<i class='imv2-war'></i> <span></span>
								</div>
								<div class='course-card-content'>
									<h3 class='course-card-name'><%=courses.get(i).getCname() %></h3>
									<p><%=courses.get(i).getCoudesc() %></p>
									<div class='clearfix course-card-bottom'>
										<div class='course-card-info'>
											评分:<%=courses.get(i).getCouscore() %><span>·</span><%=courses.get(i).getNum() %>人在学<span></span>
										</div>
